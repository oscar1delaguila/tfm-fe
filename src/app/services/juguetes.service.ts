...
export class JuguetesService {
  ...
  getAllJuguetes(): Observable<Juguetes> {
    return this.http.get<Juguetes>('https://ec2-52-47-148-224.eu-west-3.compute.amazonaws.com/juguetes/');
  }

  getJugueteById(id: string): Observable<Juguete> {
    return this.http.get<Juguete>('https://ec2-52-47-148-224.eu-west-3.compute.amazonaws.com/juguete/' + id );
  }
